...
//分页功能
const totalDataNumber = computed(() => {
shopList.value.length
})
const perPageNumber = ref(9)
const currentPage = ref()

const handleCurrentChange = () => {
console.log(totalDataNumber.value)
}
...
<template>
  <div style="margin-bottom: 20px" @keydown="testKeyDown">
    <el-row>
      <el-col :span="12">
...
<!--  分页-->
  <div style="margin:0 auto;width: 500px">
    <el-pagination background page-size="9" layout="prev, pager, next" :total="1000" @current-change="handleCurrentChange" @size-change="handleSizeChange"/>
  </div>
<!--修改功能-->
